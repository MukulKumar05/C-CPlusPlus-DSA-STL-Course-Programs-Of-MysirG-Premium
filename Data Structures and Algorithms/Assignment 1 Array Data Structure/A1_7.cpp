...
/*
A1.7 In question 1, define a method to delete an element at specified
index. 
...
int main()
{
    ...
    arr.deleteElementAtIndex(-1);
    arr.deleteElementAtIndex(9);
    arr.deleteElementAtIndex(3);
    arr.deleteElementAtIndex(0);
    arr.deleteElementAtIndex(6);
