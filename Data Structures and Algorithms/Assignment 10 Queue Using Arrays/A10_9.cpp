...
/*
A10.9 In question 1, define a method to check queue underflow.

Problem Summary: isQueueUnderflow()
(Completed)
*/
class Queue
{
...
int main()
{
    ...
    q1.insertRear(40);
    q1.insertRear(50);
    if(q1.isQueueUnderflow())
        cout<<"Queue Underflow"<<endl;
    else
        cout<<"There are elements in queue."<<endl;
    return 0;
}