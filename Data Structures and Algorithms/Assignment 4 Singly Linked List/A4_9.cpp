...
/*
A4.9 In question 1, define a method to delete a specific node.
...
int main()
{
    ...
    mylist.deleteNodewithItem(3);
    mylist.deleteNodewithItem(11);
    mylist.deleteNodewithItem(7);
    mylist.deleteNodewithItem(8);
    mylist.deleteNodewithItem(92);
    mylist.deleteNodewithItem(3);
