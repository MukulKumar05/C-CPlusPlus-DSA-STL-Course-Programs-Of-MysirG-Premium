...
/*
A14.9 In question 1, define a method to search an item
in the BST.

Problem Summary: define searchNodewithItem(int data);
(Completed)
*/
struct node
{
...
int main()
{
    ...
    b1.insert(22);
    b1.insert(18);
    if(b1.searchNodewithItem(25))
        cout<<"Item found in BST."<<endl;
    else
        cout<<"Item not found in BST."<<endl;
    return 0;
}