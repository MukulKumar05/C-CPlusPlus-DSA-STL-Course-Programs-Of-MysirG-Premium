...
/*
A20.8 In question-1, define a copy constructor to perform deep copy.
...
int main()
{
    ...
    // h1.displayHeapElements();
    // try
    // {
    //     h1.max();
    //     cout<<"The greatest value in Heap is "<<h1.max()<<endl;
    // }
    // catch(int e)
    // {
    //     cout<<"Cannot find the greatest value in heap because the heap is empty."<<endl;
    // }
    Heap h2 = h1;
    h2.del();
    cout<<"The greatest value of heap h1 is "<<h1.max()<<endl;
    cout<<"The greatest value of heap h2 is "<<h2.max()<<endl;
    return 0;
}