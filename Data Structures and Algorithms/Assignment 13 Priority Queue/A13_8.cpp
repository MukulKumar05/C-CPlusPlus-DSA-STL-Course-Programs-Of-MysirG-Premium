...
/*
A13.8 In question 1, define a method to check if Priority Queue
is empty.

Problem Summary: define isPriorityQueueEmpty()
(Completed)
*/
struct node
{
...
bool PriorityQueue::isPriorityQueueEmpty()
{
