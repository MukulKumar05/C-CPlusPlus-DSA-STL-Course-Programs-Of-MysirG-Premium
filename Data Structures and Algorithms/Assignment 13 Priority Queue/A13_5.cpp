...
/*
A13.5 In question 1, define a method to get highest priority element.

Problem Summary: define getHighestPriorityElement()
(Completed)
*/
struct node
{
...
int main()
{
    ...
    try
    {
        p1.getHighestPriorityElement();
        cout<<"Highest priority element in queue is "<<p1.getHighestPriorityElement()<<endl;
    }
    catch(int e)
    {
