...
/*
A6.5 In question 1, define a method to search a node with the
given item.
...
int main()
{
    ...
    node *searchResult = mylist.searchNodeWithItem(9);
    if(searchResult)
        cout<<"Node found in CLL"<<endl;
    else
        cout<<"Node not found in CLL"<<endl;
    return 0;
}